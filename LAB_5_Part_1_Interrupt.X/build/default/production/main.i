...
Setup:
    ...
    ; Bank 0
    BANKSEL INTCON
    BCF INTCON,1 ;clear any stale request first
    BSF INTCON,4 ;enable the ((PORTB) and 07Fh), 0/INT source
...
Main:
    ...
    XORWF PORTA,1 ;toggle ((PORTA) and 07Fh), 0 as fast as the loop allows
    GOTO Main
    ...
    BTFSS INTCON,1 ;check if it was ((PORTB) and 07Fh), 0
    ...
    BCF INTCON,1 ;software must clear the request
